              ...
              >
                ...
                <div class="relative z-10">
                  ...
                  <div class="flex items-baseline gap-2 mb-10">
                    <span class="text-xs font-black text-blue-400">IDR</span>
...
const fetchTour = async () => {
  loading.value = true;
  try {
    const response = await getTourDetail(route.params.slug);
    const rawTour = response.data.data;
...
const summaryItems = computed(() => [
  {
    label: "Duration",
    value: `${tour.value?.duration_days}D / ${tour.value?.duration_nights}N`,
    icon: ClockIcon,
  },
