export default {
  ...
  categoryLanding: {
    ...
    local: {
      titlePrefix: "All",
      titleHighlight: "Manado Tours Categories",
      description:
        "Choose the local travel category that fits your Manado, Bunaken, Tomohon, and nearby exploration best.",
      emptyDescription: "Local categories are not available right now.",
    ...
    national: {
      ...
      emptyDescription: "National categories are not available right now.",
      badge: "National Category",
    },
  },
  localTourDetail: {
  ...
  tour: {
    ...
    investment: "Investment Starts From",
    pricingInfo: "Pricing Information",
    contactInquiry: "Contact us for price inquiry",
    expertGuide: "Expert Local Guide",
    premiumAcc: "Premium Accommodation",
    safetyEquip: "Safety Equipment Included",
